...
const data = {
  ...
  ja: {
    ...
    steps: [['最終組立・検査待ち', '完成品を最終の量産検査工程へ移します。'], ['すべての流路を個別検査', '対象流路を1.0 MPaで検査し、他の流路は無加圧で大気開放とします。'], ['加圧・保圧', '約1秒かけて加圧し、4秒間保圧します。'], ['全流路合格後に工程移行', 'すべての流路が合格した製品だけを梱包・入庫します。'], ['NG品の隔離と処置', '黄色の不適合品隔離容器に移し、原因を確認します。修理可能品は修理後に全流路を再検査し、修理不可と判定した製品は廃棄します。']],
    tableTitle: '確認済みの量産検査条件', col1: '検査項目', col2: '現在の量産工程',
    rows: [['検査工程', '最終組立後'], ['検査対象', '完成品の100％（全数）'], ['流路の検査範囲', 'すべての流路を個別に検査'], ['媒体・圧力', '1.0 MPa（約10 bar）の圧縮空気'], ['その他の流路の状態', '無加圧で大気開放'], ['検査サイクル', '約1秒の加圧と4秒間の保圧'], ['NG品の処置', '黄色の不適合品隔離容器へ移し、原因確認、修理後の全流路再検査、または廃棄'], ['工程移行条件', 'すべての流路が合格した後に梱包・入庫']],
