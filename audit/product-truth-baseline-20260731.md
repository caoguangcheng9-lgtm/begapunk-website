...
Normalized fact observations: **2146**

## 4. Conflict baseline

Unresolved conflicts: **59**
...
| `BP-2P-50-0001` | `compatible_media` | `air`<br>`air\|coolant\|oil\|water` | Yes | Yes | Yes |
| `BP-2P-50-0001` | `mounting_type` | `4xm5\|6xm5\|rotor\|stator`<br>`6xm5\|flange`<br>`flange` | Yes | Yes | Yes |
| `BP-2P-50-0001` | `protection_rating` | `dust-proof`<br>`IP65` | Yes | Yes | Yes |
| `BP-2P-50-0001` | `seal_material` | `fkm\|o-ring\|ptfe`<br>`o-ring\|ptfe` | Yes | Yes | Yes |
| `BP-2P-50-0001` | `weight` | `2.3 kg`<br>`4.26 kg` | Yes | Yes | Yes |
...
- BP-2P-50-0001 / compatible_media: check downloads/BP-2P-50-0001.pdf; current approved engineering drawing; formal datasheet or order-specific specification
...
- BP-2P-50-0001 / protection_rating: check downloads/BP-2P-50-0001.pdf; current approved engineering drawing; formal datasheet or order-specific specification
- BP-2P-50-0001 / seal_material: check downloads/BP-2P-50-0001.pdf; current approved engineering drawing; formal datasheet or order-specific specification
...
| --- | --- | --- |
| `weight` | `Approx. 4.26 kg (4,260 g)` — `BP-2P-50-0001.html` (website-product-spec, SHA-256 `129fd87b3ffc435436f777fcb4ec51383b50ca028ebf1fecdee0f1fe32ebc336`)<br>`Approx. 4.26 kg (4,260 g)` — `BP-2P-50-0001.html` (website-json-ld, SHA-256 `129fd87b3ffc435436f777fcb4ec51383b50ca028ebf1fecdee0f1fe32ebc336`)<br>`Ca. 4.26 kg (4,260 g)` — `de/BP-2P-50-0001.html` (translated-product-spec, SHA-256 `0f023719bd08bda282c92b62b6ccc92d16c8d6e56c4d9faefceee8290f656ecc`)<br>`ca. 4,26 kg (4.260 g)` — `de/BP-2P-50-0001.html` (translated-json-ld, SHA-256 `0f023719bd08bda282c92b62b6ccc92d16c8d6e56c4d9faefceee8290f656ecc`)<br>`交通アクセス 4.26 kg (4,260 g)` — `ja/BP-2P-50-0001.html` (translated-product-spec, SHA-256 `3d129ea3aa82026ebbc5074bdbdf62fe667ae96ed3ab7f804d59cf4aa7a0c23d`)<br>`約 4.26 kg（4,260 g）` — `ja/BP-2P-50-0001.html` (translated-json-ld, SHA-256 `3d129ea3aa82026ebbc5074bdbdf62fe667ae96ed3ab7f804d59cf4aa7a0c23d`)<br>`Приближается. 4.26 kg (4,260 g)` — `ru/BP-2P-50-0001.html` (translated-product-spec, SHA-256 `9409521135f094fb8999175279b3dbf363179b4277d574c0f8e50801c7894469`)<br>`Около 4,26 кг (4 260 g)` — `ru/BP-2P-50-0001.html` (translated-json-ld, SHA-256 `9409521135f094fb8999175279b3dbf363179b4277d574c0f8e50801c7894469`)<br>`2.3 kg` — `catalog-project/data/catalog-data.csv` (local-untracked-source, SHA-256 `e366e2f2d699fc387065795904b280860bfc146d8dd8a16034dfaed4beb1a510`)<br>`2.3 kg` — `catalog-project/data/catalog-data.json` (local-untracked-source, SHA-256 `0e277cdc4156ed949e3b6e8fc6d9d2647729e0e0f80a59ed4006608369b82e2e`)<br>`Approx. 4.26 kg` — `audit/fact-resolution/phase-1e-a/product-fact-conflicts.csv` (website-audit-observation, SHA-256 `33c482809594992c9e22d1730fc522c9f7e157afb7cc38893ea423784d5ba469`)<br>`2300 g (2.30 kg)` — `audit/fact-resolution/phase-1e-a/product-fact-conflicts.csv` (engineering-audit-observation, SHA-256 `33c482809594992c9e22d1730fc522c9f7e157afb7cc38893ea423784d5ba469`) | `unresolved`; manual engineering verification required |
| `compatible_media` | `Air, water, water-soluble coolant, light hydraulic oil (ISO VG 32 max)` — `BP-2P-50-0001.html` (website-product-spec, SHA-256 `129fd87b3ffc435436f777fcb4ec51383b50ca028ebf1fecdee0f1fe32ebc336`)<br>`Air, water, water-soluble coolant, light hydraulic oil (ISO VG 32 max)` — `BP-2P-50-0001.html` (website-json-ld, SHA-256 `129fd87b3ffc435436f777fcb4ec51383b50ca028ebf1fecdee0f1fe32ebc336`)<br>`Luft, Wasser, wasserlösliches Kühlmittel, leichtes Hydrauliköl (ISO VG 32 max)` — `de/BP-2P-50-0001.html` (translated-product-spec, SHA-256 `0f023719bd08bda282c92b62b6ccc92d16c8d6e56c4d9faefceee8290f656ecc`)<br>`Luft, Wasser, wassermischbares Kühlmittel, leichtes Hydrauliköl (max. ISO VG 32)` — `de/BP-2P-50-0001.html` (translated-json-ld, SHA-256 `0f023719bd08bda282c92b62b6ccc92d16c8d6e56c4d9faefceee8290f656ecc`)<br>`空気、水、水溶性のクーラント、軽い油圧オイル(ISO VG 32最高)` — `ja/BP-2P-50-0001.html` (translated-product-spec, SHA-256 `3d129ea3aa82026ebbc5074bdbdf62fe667ae96ed3ab7f804d59cf4aa7a0c23d`)<br>`空気、水、水溶性クーラント、低粘度作動油（ISO VG 32以下）` — `ja/BP-2P-50-0001.html` (translated-json-ld, SHA-256 `3d129ea3aa82026ebbc5074bdbdf62fe667ae96ed3ab7f804d59cf4aa7a0c23d`)<br>`Воздух, вода, водорастворимая охлаждающая жидкость, легкое гидравлическое масло (ISO VG 32 макс.)` — `ru/BP-2P-50-0001.html` (translated-product-spec, SHA-256 `9409521135f094fb8999175279b3dbf363179b4277d574c0f8e50801c7894469`)<br>`Воздух, вода, водорастворимая СОЖ, маловязкое гидравлическое масло (не выше ISO VG 32)` — `ru/BP-2P-50-0001.html` (translated-json-ld, SHA-256 `9409521135f094fb8999175279b3dbf363179b4277d574c0f8e50801c7894469`)<br>`Air` — `catalog-project/data/catalog-data.csv` (local-untracked-source, SHA-256 `e366e2f2d699fc387065795904b280860bfc146d8dd8a16034dfaed4beb1a510`)<br>`Air` — `catalog-project/data/catalog-data.json` (local-untracked-source, SHA-256 `0e277cdc4156ed949e3b6e8fc6d9d2647729e0e0f80a59ed4006608369b82e2e`) | `unresolved`; manual engineering verification required |
| `protection_rating` | `IP65-rated labyrinth seal and protective shroud` — `BP-2P-50-0001.html` (website-product-spec, SHA-256 `129fd87b3ffc435436f777fcb4ec51383b50ca028ebf1fecdee0f1fe32ebc336`)<br>`IP65 dust-proof structure` — `BP-2P-50-0001.html` (website-json-ld, SHA-256 `129fd87b3ffc435436f777fcb4ec51383b50ca028ebf1fecdee0f1fe32ebc336`)<br>`Labyrinthbereich mit Schutzhaube` — `de/BP-2P-50-0001.html` (translated-product-spec, SHA-256 `0f023719bd08bda282c92b62b6ccc92d16c8d6e56c4d9faefceee8290f656ecc`)<br>`IP65 staubgeschützte Ausführung` — `de/BP-2P-50-0001.html` (translated-json-ld, SHA-256 `0f023719bd08bda282c92b62b6ccc92d16c8d6e56c4d9faefceee8290f656ecc`)<br>`ラビリンス部と保護カバー` — `ja/BP-2P-50-0001.html` (translated-product-spec, SHA-256 `3d129ea3aa82026ebbc5074bdbdf62fe667ae96ed3ab7f804d59cf4aa7a0c23d`)<br>`IP65 防じん構造` — `ja/BP-2P-50-0001.html` (translated-json-ld, SHA-256 `3d129ea3aa82026ebbc5074bdbdf62fe667ae96ed3ab7f804d59cf4aa7a0c23d`)<br>`Лабиринт и защитный кожух` — `ru/BP-2P-50-0001.html` (translated-product-spec, SHA-256 `9409521135f094fb8999175279b3dbf363179b4277d574c0f8e50801c7894469`)<br>`IP65 пылезащищённая конструкция` — `ru/BP-2P-50-0001.html` (translated-json-ld, SHA-256 `9409521135f094fb8999175279b3dbf363179b4277d574c0f8e50801c7894469`)<br>`Staubgeschützt` — `de/products.html` (translated-product-card, SHA-256 `acb8af1c42644a1a76d7cf001466c8d1d8c6731c0ad053925e55a8632a08dbd1`)<br>`Dust-Proof` — `products.html` (website-product-card, SHA-256 `d641757ccf9ec79b61facadc24d53d0a0035d14390e8a4ff6a98f2405e3cde18`)<br>`Пылезащищённое исполнение` — `ru/products.html` (translated-product-card, SHA-256 `5b7c472fa62ae679528b3258e1628264efc76062abbacaf378eec545400faedb`) | `manual-review-required`; public IP65 statements exist, but Phase 1A did not establish approval of the drawing or protection test evidence |
| `mounting_type` | `Flange Mount (6-M5)` — `BP-2P-50-0001.html` (website-product-spec, SHA-256 `129fd87b3ffc435436f777fcb4ec51383b50ca028ebf1fecdee0f1fe32ebc336`)<br>`Flange mount (6-M5)` — `BP-2P-50-0001.html` (website-json-ld, SHA-256 `129fd87b3ffc435436f777fcb4ec51383b50ca028ebf1fecdee0f1fe32ebc336`)<br>`Flanschmontage; Lochbild gemäß Zeichnung` — `de/BP-2P-50-0001.html` (translated-product-spec, SHA-256 `0f023719bd08bda282c92b62b6ccc92d16c8d6e56c4d9faefceee8290f656ecc`)<br>`Flanschmontage (6-M5)` — `de/BP-2P-50-0001.html` (translated-json-ld, SHA-256 `0f023719bd08bda282c92b62b6ccc92d16c8d6e56c4d9faefceee8290f656ecc`)<br>`フランジ取付（穴配置は図面参照）` — `ja/BP-2P-50-0001.html` (translated-product-spec, SHA-256 `3d129ea3aa82026ebbc5074bdbdf62fe667ae96ed3ab7f804d59cf4aa7a0c23d`)<br>`フランジ取付（6-M5）` — `ja/BP-2P-50-0001.html` (translated-json-ld, SHA-256 `3d129ea3aa82026ebbc5074bdbdf62fe667ae96ed3ab7f804d59cf4aa7a0c23d`)<br>`Фланцевое крепление; отверстия по чертежу` — `ru/BP-2P-50-0001.html` (translated-product-spec, SHA-256 `9409521135f094fb8999175279b3dbf363179b4277d574c0f8e50801c7894469`)<br>`Фланцевое крепление (6-M5)` — `ru/BP-2P-50-0001.html` (translated-json-ld, SHA-256 `9409521135f094fb8999175279b3dbf363179b4277d574c0f8e50801c7894469`)<br>`Flanschmontage` — `de/products.html` (translated-product-card, SHA-256 `acb8af1c42644a1a76d7cf001466c8d1d8c6731c0ad053925e55a8632a08dbd1`)<br>`フランジ取付` — `ja/products.html` (translated-product-card, SHA-256 `5c6b35afb4a6f4e4b193be9463e49939652f44227afa775348b88ddc47544bf9`)<br>`Flange Mount` — `products.html` (website-product-card, SHA-256 `d641757ccf9ec79b61facadc24d53d0a0035d14390e8a4ff6a98f2405e3cde18`)<br>`фланцевое крепление` — `ru/products.html` (translated-product-card, SHA-256 `5b7c472fa62ae679528b3258e1628264efc76062abbacaf378eec545400faedb`) | `unresolved`; manual engineering verification required |
